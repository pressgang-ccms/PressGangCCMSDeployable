...
class MySqlH2Conversion {
    ...
    def final static tableOrder = ['DATABASECHANGELOGLOCK', 'DATABASECHANGELOG', 'REVINFO', 'BugzillaBug', 'BugzillaBug_AUD', 'IntegerConstants', 'IntegerConstants_AUD', 'RelationshipTag', 'RelationshipTag_AUD', 'Role', 'Role', 'RoleToRole', 'RoleToRoleRelationship', 'RoleToRoleRelationship_AUD', 'RoleToRole_AUD', 'Role_AUD', 'File', 'File_AUD', 'LanguageFile', 'LanguageFile_AUD', 'StringConstants', 'StringConstants_AUD', 'BlobConstants', 'BlobConstants_AUD', 'ImageFile', 'ImageFile_AUD', 'LanguageImage', 'LanguageImage_AUD', 'Topic', 'Topic_AUD', 'Tag', 'Tag_AUD', 'Category', 'Category_AUD', 'PropertyTag', 'PropertyTag_AUD', 'PropertyTagCategory',
            ...
            'TopicSecondOrderData_AUD', 'Filter', 'Filter_AUD', 'FilterCategory', 'FilterCategory_AUD', 'FilterField', 'FilterField_AUD', 'FilterLocale', 'FilterLocale_AUD', 'FilterOption', 'FilterOption_AUD', 'FilterTag', 'FilterTag_AUD', 'TagExclusion', 'TagExclusion_AUD', 'TagToTag', 'TagToTagRelationship', 'TagToTagRelationship_AUD', 'TagToTag_AUD', 'TopicSourceURL', 'TopicSourceURL_AUD', 'TopicToBugzillaBug', 'TopicToBugzillaBug_AUD', 'TopicToTopic', 'TopicToTopicSecondOrderData', 'TopicToTopicSourceURL', 'TopicToTopicSourceURL_AUD', 'TopicToTopic_AUD', 'TranslatedTopic', 'TranslatedTopicData', 'TranslatedTopicData_AUD', 'TranslatedTopicString', 'TranslatedTopicString_AUD', 'TranslatedTopic_AUD', 'UserRole', 'UserRole_AUD', ];
